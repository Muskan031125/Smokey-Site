...
use App\Filters\AdminWriteFilter;
...
class Filters extends BaseFilters
{
    ...
    public array $aliases = [
        ...
        'admin-write'       => AdminWriteFilter::class,
        'superadmin'        => SuperAdminFilter::class,
        'client'            => ClientFilter::class,
        'force-password'    => ForcePasswordChangeFilter::class,
    ];
    ...
    public array $globals = [
        'before' => [
            // no global force-password for smokey (customers register freely)
        ],
        'after' => [
            // 'honeypot',
            // 'secureheaders',
